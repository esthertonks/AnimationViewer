...
void main()
{
	...
	//for(int weightIndex = 0; weightIndex < MAX_INFLUENCES; weightIndex++) // Put the verts into position and THEN skin them //TODO could do this in software on batching and remove the need for the model matrix (and thus have many less batches)
	//{
